...
public static class StringExtensions
{
    ...
    /// <see langword="null"/>, or an <see cref="ArgumentException"/> when it consists only of
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="argument"/> is only whitespace.</exception>
    public static void ThrowIfNullOrWhiteSpace(
        [NotNull] this string? argument,
        [CallerArgumentExpression(nameof(argument))] string parameterName = null!)
            => ArgumentNullException.ThrowIfNullOrWhiteSpace(argument, parameterName);
}
